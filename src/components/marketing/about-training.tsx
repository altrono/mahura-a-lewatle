...
export function AboutTraining() {
  return (
            ...
            <section id="about-us" className=" max-w-7xl mx-auto bg-white  bg-[url('/about.png')] bg-cover  bg-center] ">
              <div className="px-4 flex  flex-col md:flex-row w-full h-full py-20 md:px-20 bg-blue-950/40  min-h-[400px]">
                <motion.div
